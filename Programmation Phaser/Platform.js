class Platform extends Phaser.Scene{
    ...
    preload(){
        ...
        //Vie
        this.load.image('barre_de_vie_3hp', 'assets/barre_de_vie.png');
        this.load.image('barre_de_vie_2hp', 'assets/barre_de_vie.png');
        this.load.image('barre_de_vie_1hp', 'assets/barre_de_vie.png');
    ...
    update(){
        ...
        if (this.player.body.velocity.x !== 0) this.player.anims.play("run", true);
